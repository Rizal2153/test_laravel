...
<body>
    ...
    <br/>
    <br/>
    {{-- <form id="form_pegawai" action="/pegawai/store" method="post"> --}}
    <form id="form_barang">
        {{  csrf_field() }}
        ...
        {{-- Created Date <input type="date" name="created_date" required="required"><br/>
        Modified Date <input type="date" name="modified_date" required="required"><br/> --}}
